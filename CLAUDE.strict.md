1. IronHive.Core.Resilience 및 Streaming의 용도가 분명하지 않음, 자세한 설명추가
2. IronHive.Abstractions.Messages의 ToolLimit관련 사항 검토
...
3. **주의** IronHive.Providers.OpenAI에 다른 provider 지원금지
  ...
  - OpenAI의 규격을 따르나 조금 다른 기능들이 있을경우, 따로 IronHive.Providers.(openai_compatibles)패키지를 생성하고, IronHive.Providers.OpenAI를 상속받아 따로 구현하세요.
