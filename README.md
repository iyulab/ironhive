...
- **토큰 로그 확률** — `MessageRequest.LogProbabilities`(상위 대안 0~20)로 출력 토큰별 로그 확률을 받는다(`MessageResponse.LogProbabilities`, 스트리밍 델타에도; OpenAI Compatible, [docs/PROVIDERS.md](docs/PROVIDERS.md))
