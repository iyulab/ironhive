...
{
    /// <summary>
    /// 디코딩 가능한 파일의 확장자 목록을 반환합니다.
    /// </summary>
    IEnumerable<string> GetDecodableExtensions();

    /// <summary>
    /// 파일확장자를 기반으로 MIME 타입을 반환합니다.
    /// </summary>
    string? GetMimeType(string fileName);

    /// <summary>
    /// 지정한 경로의 파일을 비동기적으로 읽어들여 텍스트로 변환합니다.
    /// </summary>
    Task<string> DecodeFileAsync(
        string provider,
        string filePath,
