...
/// <summary>
/// 등록된 파일 저장소에 대한 파일 작업을 수행하는 서비스입니다.
/// </summary>
public interface IFileStorageService
{
    ...
    /// </summary>
    /// <param name="storageName">스토리지 이름 또는 식별자</param>
    ...
    /// </summary>
    /// <param name="storageName">스토리지 이름 또는 식별자</param>
    /// <param name="filePath">확인할 파일 또는 디렉터리 경로</param>
    ...
    /// </summary>
    /// <param name="storageName">스토리지 이름 또는 식별자</param>
    /// <param name="filePath">삭제할 파일 또는 디렉터리 경로</param>
    ...
    /// <summary>
    /// 지정한 경로의 디렉터리 및 그 안의 모든 내용을 비동기적으로 삭제합니다.
    /// </summary>
    /// <param name="storageName">스토리지 이름 또는 식별자</param>
    /// <param name="directoryPath">삭제할 디렉터리 경로</param>
