...
public class EmbeddingDocumentHandler : IPipelineHandler
{
    ...
    public async Task<DataPipeline> ProcessAsync(DataPipeline pipeline, CancellationToken cancellationToken)
    {
        ...
        //var embeddingModel = "???";
        //var embeddings = new List<VectorPoint>();
        ...
        //    });
        //    embeddings.Add(new VectorPoint
        //    {
        ...
        //await _vectorStorage.UpsertVectorsAsync(
