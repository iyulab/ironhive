...
/// <summary>
/// Message generator targeting the OpenAI <b>Responses</b> API (<c>POST /v1/responses</c>).
/// Selected when <see cref="OpenAIConfig.Api"/> is <see cref="OpenAIApiSurface.Responses"/> (the first-party default).
/// Supports reasoning summaries and <c>reasoning.encrypted_content</c>. Not implemented by OpenAI-compatible
/// servers — for those use the Chat Completions surface (see <see cref="OpenAIChatMessageGenerator"/>).
/// </summary>
